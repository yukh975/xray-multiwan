...
Один Linux-хост с несколькими связками xray+tun2socks — по одной на WAN-выход. Клиент выбирает выход, указывая разные IP в качестве шлюза: например, `.232` → первый выход, `.233` → второй, `.234` → третий.
